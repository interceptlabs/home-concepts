...
**Concept D — Home Variant** is the odd one out on purpose: it's a speculative variant of the currently deployed homepage rather than a new structural idea. It keeps the deployed site's sticky nav and logo treatment, swaps in a full-screen light-mode motion-graphics video, and turns each existing homepage section into a small card that expands into a modal holding that section's complete, unmodified module. Nav items route to standalone pages built from the same modules, and About/Insights/ChatB2B are mirrored straight from the deployed bundle.
...
**Concept D**
- Click a card to expand its full module
- Esc closes a modal
- The nav routes to full section pages
...
- Concept D: `.planning/phases/05-concept-d-home-variant/captures/` (10 captures), `05-VERIFICATION.md`, and the QA table in `05-03-SUMMARY.md`
